  ...
  <app-layout title="Productos">
    ...
    <div class="py-12">
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <button  @click="nuevo()" class="py-3 px-6 text-white rounded-sm bg-green-400 shadow-sm block md:inline-block">nuevo</button>
                      ...
                      >
                        <td class="py-3 px-6">
                          <div class="flex items-center">
                            <span class="font-medium" v-text="objeto.nombre"></span>
                          </div>
                        </td>
                        ...
                        <td class="py-3 px-6">
                          <div class="flex items-center">
                            <span class="font-medium">{{ objeto.medida }}</span>
                          </div>
                        </td>
